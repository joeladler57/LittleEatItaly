...
# Customer and Loyalty Models/Functions are imported from routers package
# See: routers/customers.py and routers/loyalty.py
...
# ============ STAFF AUTH HELPERS (for router compatibility) ============
# Note: Staff endpoints moved to routers/staff.py
...
@api_router.put("/terminal/tables/{table_id}")
...
@api_router.delete("/terminal/tables/{table_id}")
...
# --- Terminal Waiters (Admin) ---
@api_router.get("/terminal/waiters")
...
@api_router.post("/terminal/waiters")
...
@api_router.put("/terminal/waiters/{waiter_id}")
...
@api_router.delete("/terminal/waiters/{waiter_id}")
...
@api_router.get("/terminal/menu/all")
...
@api_router.put("/terminal/menu/{item_id}")
...
@api_router.delete("/terminal/menu/{item_id}")
...
@api_router.get("/terminal/orders")
...
@api_router.get("/terminal/orders/today")
